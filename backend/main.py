...
def get_reference_image_path(body_type, skin_color, color_prefix="arcticfox"):
    # Map color_prefix to valid options
    if color_prefix not in ["arcticfox", "black", "heather"]:
        color_prefix = "arcticfox"
    filename = f"bodytypes/headswapper/{body_type}/{color_prefix}_headswapper_{body_type}_{skin_color}_directfull.png"
    return filename
